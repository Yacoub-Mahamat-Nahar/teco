...
@section('content')
<h1>Bibliothécaires <a href="{{ url('create-bibliothecaire') }}" class="launch-modal btn btn-sm  btn-primary pull-right" >+ Ajouter </a></h1>
<hr>
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12">
        <div class="dashboard-list-box">
            <h4 class="gray">Liste des bibliothécaires </h4>
