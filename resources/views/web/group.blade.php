...
<div class="  container bootstrap snippets bootdey" style="padding-top: 6%">
    <div class="row">
		<div class="col-md-4 bg-white ">
            <div class="border-bottom padding-sm " style="height: 35px;padding-top: 2%;padding-bottom: 2%">
            	<div class="row text-center nav-tabs">
                     <div class="col-md-6 " >
                          <button type="button" class="btn-primary show-messages">Messages</button>
                     </div>
                     <div class="col-md-6" >
                        <button type="button" class="btn-primary show-user">Joueurs</button>
                   </div>
...
$('.show-user').on('click', function(){
     ...
     var url = "{!! url('')!!}/" + "web-api-messages";
                axios.get(url)
                    .then((response) => {
                    $('.friend-list').replaceWith('<ul class="friend-list"></ul>')
                    joueurs = response.data.joueurs;
                    joueur = '';

                    joueurs.forEach(function(value) {
                       joueur +='<li>'+
                                    '<a href="javascript: void(0);" onclick="getMessages('+value.id+')" class="clearfix">'+
